...
import com.microsoft.azure.sdk.iot.device.auth.AuthenticationMethod;
...
public class ModuleClient extends InternalClient
{
    ...
    {
        throw new UnsupportedOperationException("ModuleClient does not currently support file upload");
    }
